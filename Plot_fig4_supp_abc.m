...
h1 = plot(R0_DFE_EE(ind_stable), I_frac(ind_stable),'-','Marker','.','MarkerSize',30,'MarkerIndices',1:2:length(ind_stable));
h4 = plot(R0_list, D_frac_EE,'-','Marker','o','MarkerSize',10,'MarkerIndices',1:2:length(R0_list));
h5 = plot(R0_list, A_frac_EE,'-','Marker','^','MarkerSize',10,'MarkerIndices',1:2:length(R0_list));
h2 = plot(R0_DFE_EE(ind_unstable), I_frac(ind_unstable),'r:','Marker','^','MarkerSize',5,'MarkerIndices',1:2:length(ind_unstable));
grid on
