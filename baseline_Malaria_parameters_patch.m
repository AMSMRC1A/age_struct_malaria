...
a = P.a;
np = P.np; 
% parameters could be different for different patches (vectors). 
% For now, use the same parameter for all patches.
...
P.w = w;
P.v = v;
%% patch movement matrix
P.pmat = diag(ones(P.np,1)); % people stay in their home patch
