%% plot Fig5 vaccination -- results from "run_age_structured_Malaria_vac.m"
% close all
clear all
clc
...
% load data generated by "run_age_structured_Malaria_vac.m"
DD = load(['Results/Vaccine/vp0_0.mat'],'t','a','vacc','SH_EE','EH_EE','DH_EE','AH_EE','VH_EE','PH_EE','Cm_EE','Cac_EE','Ctot_EE');
t = DD.t; a = DD.a;
vp0_list = [0,0.8]; 
% compare different vaccination level with baseline (no vac, v=0).
% Need to genearte data using "run_age_structured_Malaria_vac.m" (line 52). 
% Modify vac rate in "Malaria_parameters_transform_vac.m" (line 15)
